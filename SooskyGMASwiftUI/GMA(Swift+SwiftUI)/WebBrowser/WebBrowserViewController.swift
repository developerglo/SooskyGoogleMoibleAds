...
open class WebBrowserViewController: UIViewController {
    ...
    open var isShowPageTitleInNavigationBar = false
    ...
    open lazy var castButton: UIBarButtonItem = {
        let castIcon = WebBrowser.image(named: "cast")
        let castButton = UIBarButtonItem(image: castIcon, style: .plain, target: self, action: #selector(WebBrowserViewController.castButtonTapped(_:)))
        return castButton
    }()
...
extension WebBrowserViewController {
    ...
    @objc func castButtonTapped(_ sender: UIBarButtonItem) {
        delegate?.webBrowser(self, didCast: webView.url)
    }
...
extension WebBrowserViewController {
    ...
    fileprivate func updateToolBarState() {
        ...
        if webView.isLoading {
            barButtonItems = [backButton, itemFixedSeparator, forwardButton, itemFixedSeparator, stopButton, itemFixedSeparator, itemFlexibleSeparator]
            ...
            barButtonItems = [backButton, itemFixedSeparator, forwardButton, itemFixedSeparator, refreshButton, itemFixedSeparator, itemFlexibleSeparator]
